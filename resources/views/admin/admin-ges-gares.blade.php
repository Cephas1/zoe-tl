...
<body>
    ...
    <section id="menu">
        ...
        <div class="items">
            ...
            <li class="active"><i class="fa-solid fa-warehouse"></i><a href="{{ route('admin-index-gare') }}">Gestion des gares</a></li>
    ...
    <section id="interface">
        ...
        <div class="btn-add-dest">
            <button data-bs-toggle="modal" data-bs-target="#addDest">Ajouter une gare</button>
        </div>
        ...
        <div class="board">
            <table width="100%" id="user-historique" class="dataTable">
                ...
                <tbody>
                    @foreach ($gares as $ville)
                        <tr>
                            <td>{{ $ville->name }}</td>
                            <td>
                                <a title="Modifier {{ $ville->name }}" data-bs-toggle="modal" data-bs-target="#editVille_{{ $ville->id }}" href=""><i class="fa fa-edit"></i></a>
                                <a title="Supprimer {{ $ville->name }}" href="{{ route('admin-delete-gare', $ville->id) }}"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                        <!-- Modal edit gare -->
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-edit">
                                            <form action="{{ route('admin-edit-gare', $ville->id) }}" method="POST">
                                                @csrf
        ...
        <div class="modal fade" id="addDest" tabindex="-1" aria-labelledby="addDestLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addDestLabel">Ajouter une gare</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="form-edit">
                            <form action="{{ route('admin-create-gare') }}" method="POST">
                                @csrf

                                <div class="form-group">
                                    <label for="description">Nom de la gare</label>
                                    <input type="text" name="gare" id="description" required>
                                </div>
