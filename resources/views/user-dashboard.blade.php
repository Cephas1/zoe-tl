...
<body>
    ...
    <section id="menu">
        ...
        <div class="items">
            <li class="active"><i class="fa-solid fa-chart-pie"></i><a href="">Tableau de bord</a></li>
            <li><i class="fa-solid fa-user-gear"></i></i><a href="">Mon compte</a></li>
            <li id="logout"><i class="fa-solid fa-right-from-bracket"></i><a href="">Deconnexion</a></li>
        </div>
    </section>
